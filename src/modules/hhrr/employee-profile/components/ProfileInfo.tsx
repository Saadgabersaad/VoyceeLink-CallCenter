         ...
         <Flex justifyContent='space-between' alignItems='start'>
             <Box  >
                 <Image  width={28}
                         ...
                         alt='Company'
                         src='/sample.webp'/>
                 <Typography sx={{color:PRIMARY}} variant="h5" component="h2">Brooklyn Simmons</Typography>
                 ...
                 <Flex  alignItems="center" gap={1.2}>
                     ...
                     <Typography color={"gray"} variant="subtitle2" component="h2">0101010101010</Typography>
                 </Flex>
                 <Flex  alignItems="center" gap={1.2}>
                     <BusinessCenterIcon sx={{color:PRIMARY}}/>
                     <Typography color={"gray"} variant="subtitle2" component="h2">UI Designer</Typography>
                 </Flex>
                 <Flex  alignItems="center" gap={1.2}>
                     <DeviceHubIcon sx={{color:PRIMARY}}/>
                     <Typography color={"gray"} variant="subtitle2" component="h2">Tech Department </Typography>
                 </Flex>
             </Box>
             <EditButton/>
         </Flex>
