...
export const rows = [
    ...
    {  id: '#CM9804888RA894',status:'Active' ,language: 'French - Spanish' ,speciality:'UI/UX - speciality1 - speciality2' ,client:'client Name',campaign:'USA - RS' ,liveStatus:'Not Available'},
    ...
    {  id: '#CM9804888RA897', status:'Active',language: 'English - Russian',speciality:'UI/UX - speciality1 - speciality2' , client:'client Name', campaign:'UK - USA',liveStatus:'Not Available'},
    ...
    {  id: '#CM9804888RA8992',status:'Active',language: 'English - Spanish - Arabic' ,speciality:'UI/UX - speciality1 - speciality2' ,client:'client Name', campaign:'UK - UAE',liveStatus:'Not Available'},
