...
export default function CallDetailsDrawer({status}:{status:string}) {
        ...
        >
            ...
            <Flex flexDirection="column" gap={2}>
                <Flex direction="row" justifyContent="space-between">
                    ...
                    {
                        completed ==='Missed' ? (
                            <Typography sx={{ px: 1, py: 0.5, borderRadius: '5px', bgcolor: "#F45B691A", color: '#F45B69' }}>
                                {status}
                            </Typography>
                        ) : (
                            <Typography sx={{ px: 1, py: 0.5, borderRadius: '5px', bgcolor: "#3FC28A1A", color: '#3FC28A' }}>
                              {status}
                            </Typography>
                        )
                    }
